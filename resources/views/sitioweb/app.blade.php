							...
							<ul class="navbar-nav text-center mt-2">
								...
								<li id="act_proyectos" class="nav-item dropdown ml-md-1 {{ (request()->path() == "proyectos/distrito-verde-etapa-1" || request()->path() == "proyectos/pacifico-3100-etapa-2" || request()->path() == "proyectos/pacifico-3100-etapa-1") ? 'active' : '' }}">
									...
									<ul class="b-none dropdown-menu animated fadeIn" aria-labelledby="navbarDropdown">
										<li><a class="dropdown-item {{ request()->path() == "proyectos/distrito-verde-etapa-1" ? 'active' : '' }}" href="{{route('proyectos.distrito-verde-etapa-1')}}">Distrito Verde</a></li>
										<li class="vendido"><a class="dropdown-item disabled" aria-disabled="true" title="100% VENIDO">Pacífico 3100 | Etapa II</a></li>
										<li class="vendido"><a class="dropdown-item disabled" aria-disabled="true" title="100% VENIDO">Pacífico 3100 | Etapa I</a></li>
